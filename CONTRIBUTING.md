...
Follow the [development guide](docs/development.md) to build the native app, run the tests or work on the landing page. The [recommendation policy](docs/SUGGESTIONS.md) explains what belongs in the cleanup list.
